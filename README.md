...
| Package                                    | Nuget.org |
|--------------------------------------------|-----------|
|**BlazorLocalizer**            |[![NuGet Beta](https://img.shields.io/nuget/v/BlazorLocalizer.svg)](https://www.nuget.org/packages/BlazorLocalizer)|
|**BlazorLocalizer.WebAssembly**|[![NuGet Beta](https://img.shields.io/nuget/v/BlazorLocalizer.WebAssembly.svg)](https://www.nuget.org/packages/BlazorLocalizer.WebAssembly)|
|**BlazorLocalizer.ServerSide** |[![NuGet Beta](https://img.shields.io/nuget/v/BlazorLocalizer.ServerSide.svg)](https://www.nuget.org/packages/BlazorLocalizer.ServerSide)|

## License and credits

This project is derived from the ["BlazorJsonLocalization (by Xavier Solau)"](https://www.github.com/xaviersolau/BlazorJsonLocalization). project. I use it for my personal purposes. It's licensed under the MIT license.
...
```bash
Install-Package BlazorLocalizer -version 1.0.0
Install-Package BlazorLocalizer.WebAssembly -version 1.0.0
Install-Package BlazorLocalizer.ServerSide -version 1.0.0
```

**Install using the .Net CLI:**
```bash
dotnet add package BlazorLocalizer --version 1.0.0
dotnet add package BlazorLocalizer.WebAssembly --version 1.0.0
dotnet add package BlazorLocalizer.ServerSide --version 1.0.0
```

**Install editing your project file (csproj):**
```xml
<PackageReference Include="BlazorLocalizer" Version="1.0.0" />
<PackageReference Include="BlazorLocalizer.WebAssembly" Version="1.0.0" />
<PackageReference Include="BlazorLocalizer.ServerSide" Version="1.0.0" />
```
...
**BlazorLocalizer** package to enable the localization support.

#### Set up the dependency injection

A few lines of code are actually needed to setup the BlazorJsonLocalizer.
You just need to use the name space `BlazorLocalizer` to get access to
...
You can find an example in the project repository in `src/examples/BlazorLocalizer.Example.Wasm`.

* For Blazor Server Side:

First add the `using Microsoft.AspNetCore.Localization` and `using BlazorLocalizer` directives then update your
...
`src/examples/BlazorLocalizer.Example.ServerSide`.
...
In addition of the **BlazorLocalizer** package you will need the
**BlazorLocalizer.WebAssembly** extension package.
...
In addition of the **BlazorLocalizer** package you will need the
**BlazorLocalizer.ServerSide** extension package.
